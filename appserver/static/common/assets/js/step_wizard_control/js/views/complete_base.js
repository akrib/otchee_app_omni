...
function(
     ...
     */
    var viewloggingmixin=define("viewloggingmixin",[
        'underscore',
        'backbone',
        'splunk.util'
    ],
    function(
        ...
        var SplunkLogger=define("SplunkLogger",['splunk', 'splunk.util', 'logger'], function(Splunk) {
    ...
    var GlobalReflowQueue=define("GlobalReflowQueue",function(require, exports, module){
